...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>grafcet</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GrafcetExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.grafcet"));
				Grafcet root = GrafcetFactory.eINSTANCE.createGrafcet();
