/**
 */
package com.vogella.emf.Grafcet.model.grafcet.util;

import com.vogella.emf.Grafcet.model.grafcet.*;
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GrafcetPackage.GRAFCET: {
				...
				if (result == null) result = caseLocatedElement(grafcet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.STEP: {
				...
				if (result == null) result = caseLocatedElement(step);
			...
			case GrafcetPackage.TRANSITION: {
				...
				if (result == null) result = caseLocatedElement(transition);
