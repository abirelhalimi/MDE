/**
 */
package com.vogella.emf.Grafcet.model.grafcet.impl;

import com.vogella.emf.Grafcet.model.grafcet.Element;
...
import com.vogella.emf.Grafcet.model.grafcet.LocatedElement;
import com.vogella.emf.Grafcet.model.grafcet.NamedElement;
import com.vogella.emf.Grafcet.model.grafcet.Step;
import com.vogella.emf.Grafcet.model.grafcet.Transition;
...
public class GrafcetPackageImpl extends EPackageImpl implements GrafcetPackage {
	 ...
	 * @see com.vogella.emf.Grafcet.model.grafcet.GrafcetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EReference getTransition_OutcomingConnections() {
	...
	public void createPackageContents() {
		...
		createEReference(transitionEClass, TRANSITION__OUTCOMING_CONNECTIONS);
	...
	public void initializePackageContents() {
		...
		grafcetEClass.getESuperTypes().add(this.getLocatedElement());
		...
		initEReference(getGrafcet_Elements(), this.getElement(), null, "elements", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStep_IsInitial(), ecorePackage.getEBoolean(), "isInitial", "false", 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStep_IsActive(), ecorePackage.getEBoolean(), "isActive", "false", 0, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransition_OutcomingConnections(), this.getStep(), null, "outcomingConnections", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
