...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage {
	 ...
	 */
	@Override
	public EAttribute getTransition_Arrow() {
	...
	public void createPackageContents() {
		...
		createEAttribute(transitionEClass, TRANSITION__ARROW);
	...
	public void initializePackageContents() {
		...
		initEReference(getTarget_Target(), this.getState(), null, "target", null, 0, 1, Target.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTransition_Arrow(), ecorePackage.getEString(), "arrow", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_Target(), this.getTarget(), null, "target", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
