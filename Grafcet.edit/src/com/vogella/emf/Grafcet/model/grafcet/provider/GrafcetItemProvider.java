...
/**
 * This is the item provider adapter for a {@link com.vogella.emf.Grafcet.model.grafcet.Grafcet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GrafcetItemProvider extends LocatedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grafcet_connections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grafcet_connections_feature", "_UI_Grafcet_type"),
				 GrafcetPackage.Literals.GRAFCET__CONNECTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GrafcetPackage.Literals.GRAFCET__ELEMENTS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Grafcet_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__ELEMENTS,
