...
public class StateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_s_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_s_feature", "_UI_State_type"),
				 MyDslPackage.Literals.STATE__S,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((State)object).getS();
